...
preguntando el nombre de una ciudad de Brasil. Luego, muestra una alerta con el mensaje concatenando la 
...
function clickSuma(){
    ...
    alert (`La suma de ${numero1} + ${numero2} es ${resultado = numero1+numero2}`);
